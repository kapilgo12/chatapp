...
class _AuthFormState extends State<AuthForm> {
  ...
  void _trySubmit(){
   ...
   widget.submitAuth(_email.trim(),_passWord.trim(),_userName.trim(),_userImage,isLogin,context);
  }
  @override
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              widget.loading?
                RaisedButton(onPressed: null,child: CircularProgressIndicator(),):

              RaisedButton(onPressed: _trySubmit,child: Text(isLogin ?"Login" : "SignUp"),),
              FlatButton(onPressed: (){
                setState(() {
                  isLogin=!isLogin;
                });
              }, child: Text(isLogin ? "Create New Account":"I already have an Acount"))
            ],
          ),
        ),
      ),
